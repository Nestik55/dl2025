...
Помог ли nucleus sampling исправить проблемы? Да, отсекает маловероятные токены, что уменьшает бред при высоких температурах, но сохраняет разнообразие, в отличие от снижения температуры.
